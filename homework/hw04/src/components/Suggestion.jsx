...
export default function Suggestion({suggestionData, token, profileData}) {
...
<button aria-label="follow" onclick="getFollowButton(${suggestion.current_user_follow_id})" className="text-blue-700 text-sm py-2">follow</button>
</section>
        </div>)
};