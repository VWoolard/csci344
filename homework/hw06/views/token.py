...
class AccessTokenEndpoint(Resource):
    ...
    def post(self):
        ...
        # 2. Check that password is correct/matches by using built-in fucntion
        ...
        # 3. Create access and refresh tokens, which will embed the logged in user's user_id
        acces_token = flask_jwt_extended.create_access_token(identity=str(the_user.id))
